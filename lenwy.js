...
if (text.length > 500) return lenwyreply(`☘️ *Maksimal 500 Karakter*`)    
lenwyreply('☘️ *Sabar Yaa*')
var lenwyai = await fetchJson(`https://aemt.me/gpt4?text=${q}`)
 var lenai = lenwyai.result
await lenwyreply(lenai)
}
break
...
if (text.length > 500) return lenwyreply(`☘️ *Maksimal 500 Karakter*`)    
lenwyreply('☘️ *Sabar Yaa*')
var lenwyai = await fetchJson(`https://aemt.me/bingai?text=${q}`)
var lenai = lenwyai.result
await lenwyreply(lenai)
}
break
...
if (text.length > 500) return lenwyreply(`☘️ *Maksimal 500 Karakter*`)    
lenwyreply('☘️ *Sabar Yaa*')
var lenwyai = await fetchJson(`https://aemt.me/gemini?text=${q}`)
var lenai = lenwyai.result
await lenwyreply(lenai)
}
break
...
user.afkReason = text
lenwyreply(`☘️ *${pushname} Melakukan AFK*\n⚠️ *Dengan Alasan ${text ? ': ' + text : ''}*`)
}
break
